...
- en: 英文
- ja: 日本语
#### 3. 对参数进行了默认值设置，取消了`-o`参数
#### 4. 运行指定文件或目录，自动生成同名的`.ass`弹幕文件
例1：`python D:\1.xml`
> 生成`D:\1.ass`

例2：`python D:\1.xml D:\2.xml`
> 生成`D:\1.ass`，`D:\2.ass`

例3：`python D:\dir1`
> 自动转换`D:\dir1`目录下所有的xml弹幕文件，生成同名ass弹幕文件

例4：`python D:\dir1 D:\dir2`
> 自动转换`D:\dir1`，`D:\dir2`目录下所有的xml弹幕文件，生成同名ass弹幕文件
